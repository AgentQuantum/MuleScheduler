...
class TestAssignmentsEndpoints:
    ...
    def test_get_assignments_for_user(self, client, auth_token, test_user, test_location, test_time_slot):
        ...
        response = client.get(f'/api/assignments?week_start={week_start_str}',
            headers={'Authorization': f'Bearer {auth_token}'}
        )
