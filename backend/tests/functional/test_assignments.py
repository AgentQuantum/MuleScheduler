...
class TestCreateAssignmentEndpoint:
    ...
    def test_create_assignment_as_user_forbidden(self, client, auth_token, test_user, test_location, test_time_slot):
...
class TestGetAssignmentsEndpoint:
    ...
    def test_get_assignments_admin_filter_by_user(self, client, admin_token, test_user, test_location, test_time_slot):
    ...
    def test_get_assignments_admin_filter_by_location(self, client, admin_token, test_user, test_location, test_time_slot):
...
class TestUpdateAssignmentEndpoint:
    ...
    def test_update_assignment_as_admin(self, client, admin_token, test_user, test_location, test_time_slot):
    ...
    def test_update_assignment_as_user_forbidden(self, client, auth_token, test_user, test_location, test_time_slot):
...
class TestMoveAssignmentEndpoint:
    ...
    def test_move_assignment_as_admin(self, client, admin_token, test_user, test_location, test_time_slot):
    ...
    def test_move_assignment_missing_times(self, client, admin_token, test_user, test_location, test_time_slot):
    ...
    def test_move_assignment_as_user_forbidden(self, client, auth_token, test_user, test_location, test_time_slot):
    ...
    def test_move_assignment_invalid_datetime(self, client, admin_token, test_user, test_location, test_time_slot):
...
class TestDeleteAssignmentEndpoint:
    ...
    def test_delete_assignment_as_admin(self, client, admin_token, test_user, test_location, test_time_slot):
    ...
    def test_delete_assignment_as_user_forbidden(self, client, auth_token, test_user, test_location, test_time_slot):
...
class TestAvailableWorkersEndpoint:
    ...
    def test_get_available_workers_as_admin(self, client, admin_token, test_location, test_time_slot):
    ...
    def test_get_available_workers_as_user_forbidden(self, client, auth_token, test_location, test_time_slot):
    ...
    def test_get_available_workers_missing_params(self, client, admin_token):
        ...
        response = client.get(
            '/api/assignments/available-workers',
            headers={'Authorization': f'Bearer {admin_token}'}
        )
        assert response.status_code == 400
    ...
    def test_get_available_workers_with_availability(self, client, admin_token, test_location, test_time_slot):
