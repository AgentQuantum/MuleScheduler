...
from models import ShiftRequirement, Location, TimeSlot
...
class TestGetShiftRequirements:
    ...
    def test_get_shift_requirements_returns_filtered_data(self, test_app, test_location, test_time_slot, admin_token):
...
class TestCreateShiftRequirement:
    ...
    def test_create_shift_requirement_as_admin(self, client, admin_token, test_location, test_time_slot):
    ...
    def test_create_shift_requirement_as_user_forbidden(self, client, auth_token, test_location, test_time_slot):
    ...
    def test_create_shift_requirement_updates_existing(self, client, admin_token, test_location, test_time_slot):
...
class TestUpdateShiftRequirement:
    ...
    def test_update_shift_requirement_as_admin(self, test_app, admin_token, test_location, test_time_slot):
    ...
    def test_update_shift_requirement_all_fields(self, test_app, admin_token, test_location, test_time_slot):
    ...
    def test_update_shift_requirement_as_user_forbidden(self, test_app, auth_token, test_location, test_time_slot):
...
class TestDeleteShiftRequirement:
    ...
    def test_delete_shift_requirement_as_admin(self, test_app, admin_token, test_location, test_time_slot):
    ...
    def test_delete_shift_requirement_as_user_forbidden(self, test_app, auth_token, test_location, test_time_slot):
