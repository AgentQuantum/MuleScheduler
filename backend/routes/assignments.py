...
from models import Assignment, UserAvailability, ShiftRequirement, GlobalSettings, TimeSlot, User
...
def move_assignment(assignment_id):
    ...
    new_location_id = data.get('new_location_id', assignment.location_id)  # Default to current location
