  ...
  <span title={text} style={{ cursor: 'help' }}>
    {children || (
      <svg
        ...
        strokeLinecap="round"
        strokeLinejoin="round"
        style={{ opacity: 0.4, marginLeft: '4px', verticalAlign: 'middle' }}
      >
        <circle cx="12" cy="12" r="10" />
...
function AdminSettingsPage() {
  ...
  const [settings, setSettings] = useState<Settings>({
    ...
    max_hours_per_user_per_week: null,
  });
  ...
  const handleDeleteLocation = async (id: number) => {
    if (
      window.confirm(
        'Are you sure you want to delete this location? This will affect all related shifts and requirements.'
      )
    ) {
      try {
  ...
  const handleSaveDaySchedule = async () => {
    ...
    try {
      ...
      showToast(
        'success',
        `${DAY_NAMES[dayScheduleForm.day_of_week]} saved for ${formatWeekRange(weekStart)}`
      );
  ...
  const _handleDeleteTimeSlot = async (id: number) => {
    if (
      window.confirm(
        'Are you sure you want to delete this time slot? This will affect all related shifts and requirements.'
      )
    ) {
      try {
        ...
        <Col lg={3}>
          <div className="ms-card h-100">
            <div className="ms-card-header">
              <h5
                className="ms-section-title mb-0"
            ...
            <div className="ms-card-body" style={{ padding: '16px' }}>
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSettings({ ...settings, max_workers_per_shift: parseInt(e.target.value) })
                  }
                  style={{
                    width: '100%',
                    height: '6px',
              ...
              >
                ...
                <Form.Control
                  ...
                  onChange={(e) =>
                    setSettings({
                      ...settings,
                      max_hours_per_user_per_week: e.target.value ? parseInt(e.target.value) : null,
                    })
                  }
                  min={1}
                  max={40}
        ...
        <Col lg={3}>
          <div className="ms-card h-100">
            ...
            <div
              ...
              style={{ padding: locations.length === 0 ? '24px' : 0, overflow: 'visible' }}
            >
              {locations.length === 0 ? (
                <div className="text-center py-4">
                  ...
                  <p className="mb-1" style={{ color: 'var(--ms-text-muted)', fontWeight: 500 }}>
                    No locations configured
                  </p>
                  <small style={{ color: 'var(--ms-text-muted)' }}>
                  ...
                  {locations.map((loc, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <span
                            className={`ms-location-badge loc-${(index % 6) + 1}`}
                            style={{
                              display: 'inline-flex',
                              alignItems: 'center',
                              gap: '8px',
      ...
      <Modal show={showTimeSlotModal} onHide={() => setShowTimeSlotModal(false)} centered>
        <Modal.Header closeButton>
          ...
          >
            {editingTimeSlot ? (
              <>
                <Icons.Edit /> Edit Time Slot
              </>
            ) : (
              <>
                <Icons.Plus /> Add Time Slot
              </>
            )}
          </Modal.Title>
        </Modal.Header>
          ...
          <Form>
            <Form.Group className="mb-3">
              ...
              <Form.Select
                ...
                onChange={(e) =>
                  setTimeSlotForm({ ...timeSlotForm, day_of_week: parseInt(e.target.value) })
                }
              >
          ...
          <Form>
            <Form.Group className="mb-3">
              ...
              <Form.Select
                ...
                onChange={(e) =>
                  setDayScheduleForm({ ...dayScheduleForm, day_of_week: parseInt(e.target.value) })
                }
              ...
              >
                {DAY_NAMES.map((day, index) => (
                  ...
                  >
                    {day}{' '}
                    {!editingDaySchedule && configuredDays.has(index) ? '(already configured)' : ''}
                  </option>
                ))}
              </Form.Select>
            </Form.Group>
              ...
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setDayScheduleForm({ ...dayScheduleForm, start_time: e.target.value })
                    }
                    required
                  />
                </Form.Group>
              ...
              <Col>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    ...
                    onChange={(e) =>
                      setDayScheduleForm({ ...dayScheduleForm, end_time: e.target.value })
                    }
                    required
                  />
                </Form.Group>
            ...
            {dayScheduleForm.start_time && dayScheduleForm.end_time && (
              ...
              >
                ...
                <div style={{ fontSize: '0.85rem', color: 'var(--ms-text-primary)' }}>
                  ...
                  <strong>
                    {calculateSlotCount(
                      dayScheduleForm.start_time,
                      dayScheduleForm.end_time,
                      dayScheduleForm.slot_duration_minutes
                    )}
                  </strong>{' '}
                  time slots for <strong>{DAY_NAMES[dayScheduleForm.day_of_week]}</strong>
                </div>
              </div>
            )}
          </Form>
