...
function AppRoutes() {
  ...
  return (
      <Routes>
      {/* Public routes */}
        <Route path="/login" element={!user ? <LoginPage /> : <Navigate to={user.role === 'admin' ? '/admin/schedule' : '/me/availability'} replace />} />
        <Route path="/signup" element={!user ? <SignupPage /> : <Navigate to={user.role === 'admin' ? '/admin/schedule' : '/me/availability'} replace />} />
      
      {/* Student routes */}
      <Route path="/me/availability" element={
        <ProtectedRoute>
      ...
      {/* Default redirect */}
        <Route path="/" element={<Navigate to={user ? (user.role === 'admin' ? '/admin/schedule' : '/me/availability') : '/login'} replace />} />
      </Routes>
  )
}
