...
export const ScheduleIllustration: React.FC<IllustrationProps> = ({ 
  ...
  <svg width={width} height={height} viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    {/* Background shapes */}
    <ellipse cx="200" cy="270" rx="150" ry="20" fill="#E0F2FE" opacity="0.6"/>
    
    {/* Calendar base */}
    <rect x="80" y="60" width="240" height="180" rx="16" fill="white" stroke="#E5E7EB" strokeWidth="2"/>
    ...
    {/* Checkmarks */}
    <path d="M110 130 L118 138 L130 122" stroke="#059669" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M165 130 L173 138 L185 122" stroke="#0284C7" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M275 175 L283 183 L295 167" stroke="#0891B2" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>
    ...
    {/* Stars */}
    <path d="M370 120 L372 126 L378 126 L373 130 L375 136 L370 132 L365 136 L367 130 L362 126 L368 126 Z" fill="#FDE68A"/>
    <path d="M55 140 L56 144 L60 144 L57 147 L58 151 L55 148 L52 151 L53 147 L50 144 L54 144 Z" fill="#C4B5FD"/>
  </svg>
)
...
export const TeamIllustration: React.FC<IllustrationProps> = ({ 
  ...
  <svg width={width} height={height} viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    {/* Connection lines */}
    <path d="M115 170 Q160 120 165 145" stroke="#C4B5FD" strokeWidth="3" strokeLinecap="round" strokeDasharray="8 4"/>
    <path d="M285 170 Q240 120 235 145" stroke="#FDA4AF" strokeWidth="3" strokeLinecap="round" strokeDasharray="8 4"/>
    <path d="M80 195 Q200 260 320 195" stroke="#FDE68A" strokeWidth="3" strokeLinecap="round" strokeDasharray="8 4"/>
    
    {/* Floating badges */}
    <circle cx="200" cy="85" r="20" fill="#C9A227"/>
    <text x="200" y="92" textAnchor="middle" fill="white" fontSize="18" fontWeight="bold">★</text>
...
export const EmptyStateIllustration: React.FC<IllustrationProps> = ({ 
  ...
  <svg width={width} height={height} viewBox="0 0 300 240" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    {/* Background */}
    <ellipse cx="150" cy="220" rx="100" ry="15" fill="#E0F2FE" opacity="0.5"/>
    
    {/* Empty box */}
    <path d="M75 100 L150 60 L225 100 L225 180 L150 220 L75 180 Z" fill="white" stroke="#E5E7EB" strokeWidth="2"/>
...
export const SuccessIllustration: React.FC<IllustrationProps> = ({ 
  ...
  <svg width={width} height={height} viewBox="0 0 300 240" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    {/* Trophy handles */}
    <path d="M100 90 Q70 90 70 110 Q70 130 100 130" stroke="#C9A227" strokeWidth="8" fill="none" strokeLinecap="round"/>
    <path d="M200 90 Q230 90 230 110 Q230 130 200 130" stroke="#C9A227" strokeWidth="8" fill="none" strokeLinecap="round"/>
    
    {/* Star on trophy */}
    <path d="M150 95 L156 110 L172 112 L160 122 L163 138 L150 130 L137 138 L140 122 L128 112 L144 110 Z" fill="white"/>
    
    {/* Confetti */}
    <rect x="60" y="50" width="12" height="8" rx="2" fill="#FDA4AF" transform="rotate(15 66 54)"/>
    <rect x="230" y="45" width="10" height="6" rx="2" fill="#7DD3FC" transform="rotate(-20 235 48)"/>
    <rect x="85" y="35" width="8" height="12" rx="2" fill="#C4B5FD" transform="rotate(30 89 41)"/>
    <rect x="205" y="60" width="12" height="6" rx="2" fill="#6EE7B7" transform="rotate(-10 211 63)"/>
    
    {/* Stars */}
    <path d="M70 80 L72 86 L78 86 L73 90 L75 96 L70 92 L65 96 L67 90 L62 86 L68 86 Z" fill="#FDE68A"/>
    <path d="M240 75 L242 81 L248 81 L243 85 L245 91 L240 87 L235 91 L237 85 L232 81 L238 81 Z" fill="#FDA4AF"/>
  </svg>
)
...
export const FocusModeIllustration: React.FC<IllustrationProps> = ({ 
  ...
  <svg width={width} height={height} viewBox="0 0 300 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M78 75 L82 79 L88 71" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M123 75 L127 79 L133 71" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    
    {/* Clock icon */}
    <circle cx="255" cy="55" r="20" fill="white" opacity="0.2"/>
    <circle cx="255" cy="55" r="15" fill="white" opacity="0.15"/>
    <line x1="255" y1="55" x2="255" y2="45" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
    <line x1="255" y1="55" x2="262" y2="58" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
    ...
    {/* Stars/sparkles */}
    <path d="M50 50 L52 56 L58 56 L53 60 L55 66 L50 62 L45 66 L47 60 L42 56 L48 56 Z" fill="white" opacity="0.5"/>
    <path d="M270 90 L271 94 L275 94 L272 97 L273 101 L270 98 L267 101 L268 97 L265 94 L269 94 Z" fill="white" opacity="0.4"/>
  </svg>
)
...
export const AvailabilityIllustration: React.FC<IllustrationProps> = ({ 
  ...
  <svg width={width} height={height} viewBox="0 0 400 300" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    {/* Clock hands */}
    <line x1="200" y1="140" x2="200" y2="85" stroke="#002169" strokeWidth="6" strokeLinecap="round"/>
    <line x1="200" y1="140" x2="240" y2="120" stroke="#002169" strokeWidth="4" strokeLinecap="round"/>
    <line x1="200" y1="140" x2="180" y2="160" stroke="#C9A227" strokeWidth="2" strokeLinecap="round"/>
    ...
    <rect x="320" y="80" width="50" height="25" rx="6" fill="#D1FAE5" stroke="#6EE7B7" strokeWidth="2"/>
    <text x="345" y="97" textAnchor="middle" fill="#059669" fontSize="12" fontWeight="bold">✓</text>
    
    <rect x="320" y="115" width="50" height="25" rx="6" fill="#D1FAE5" stroke="#6EE7B7" strokeWidth="2"/>
    <text x="345" y="132" textAnchor="middle" fill="#059669" fontSize="12" fontWeight="bold">✓</text>
    
    <rect x="320" y="150" width="50" height="25" rx="6" fill="#FEF3C7" stroke="#FDE68A" strokeWidth="2"/>
    <text x="345" y="167" textAnchor="middle" fill="#D97706" fontSize="12" fontWeight="bold">?</text>
    
    <rect x="30" y="100" width="50" height="25" rx="6" fill="#FFE4E6" stroke="#FDA4AF" strokeWidth="2"/>
    <text x="55" y="117" textAnchor="middle" fill="#E11D48" fontSize="12" fontWeight="bold">✗</text>
    
    <rect x="30" y="135" width="50" height="25" rx="6" fill="#D1FAE5" stroke="#6EE7B7" strokeWidth="2"/>
    <text x="55" y="152" textAnchor="middle" fill="#059669" fontSize="12" fontWeight="bold">✓</text>
...
export const NoWorkersIllustration: React.FC<IllustrationProps> = ({ 
  ...
  <svg width={width} height={height} viewBox="0 0 300 240" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <circle cx="100" cy="100" r="35" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="2" strokeDasharray="8 4"/>
    <ellipse cx="100" cy="175" rx="25" ry="35" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="2" strokeDasharray="8 4"/>
    ...
    <circle cx="200" cy="100" r="35" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="2" strokeDasharray="8 4"/>
    <ellipse cx="200" cy="175" rx="25" ry="35" fill="#E5E7EB" stroke="#D1D5DB" strokeWidth="2" strokeDasharray="8 4"/>
...
export const LoadingIllustration: React.FC<IllustrationProps> = ({ 
  ...
  <svg width={width} height={height} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <text x="100" y="108" textAnchor="middle" fill="white" fontSize="28" fontWeight="bold">🫏</text>
  </svg>
)
